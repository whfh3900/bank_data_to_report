...
def split_data(path):
    ...
    case_1.to_csv(path+"/case_1.csv", encoding="utf-8-sig")
    ...
    case_1_1.to_csv(path+"/case_1_1.csv", encoding="utf-8-sig")
    ...
    case_2.to_csv(path+"/case_2.csv", encoding="utf-8-sig")
    ...
    case_3.to_csv(path+"/case_3.csv", encoding="utf-8-sig")
    ...
    case_4.to_csv(path+"/case_4.csv", encoding="utf-8-sig")
    ...
    case_5.to_csv(path+"/case_5.csv", encoding="utf-8-sig")
    ...
    case_6.to_csv(path+"/case_6.csv", encoding="utf-8-sig")
    ...
    case_7.to_csv(path+"/case_7.csv", encoding="utf-8-sig")
    ...
    case_8.to_csv(path+"/case_8.csv", encoding="utf-8-sig")
    ...
    case_9.to_csv(path+"/case_9.csv", encoding="utf-8-sig")
    ...
    case_10.to_csv(path+"/case_10.csv", encoding="utf-8-sig")
    ...
    case_10_1.to_csv(path+"/case_10_1.csv", encoding="utf-8-sig")
    ...
    case_10_2.to_csv(path+"/case_10_2.csv", encoding="utf-8-sig")
    ...
    case_11.to_csv(path+"/case_11.csv", encoding="utf-8-sig")
    ...
    case_12.to_csv(path+"/case_12.csv", encoding="utf-8-sig")
    ...
    case_13.to_csv(path+"/case_13.csv", encoding="utf-8-sig")
    ...
    case_14.to_csv(path+"/case_14.csv", encoding="utf-8-sig")
    ...
    case_15.to_csv(path+"/case_15.csv", encoding="utf-8-sig")
    ...
    case_16.to_csv(path+"/case_16.csv", encoding="utf-8-sig")
    ...
    case_17.to_csv(path+"/case_17.csv", encoding="utf-8-sig")
    ...
    case_18.to_csv(path+"/case_18.csv", encoding="utf-8-sig")
    ...
    case_19.to_csv(path+"/case_19.csv", encoding="utf-8-sig")
    ...
    case_20.to_csv(path+"/case_20.csv", encoding="utf-8-sig")
    ...
    case_21.to_csv(path+"/case_21.csv", encoding="utf-8-sig")
    ...
    case_21_1.to_csv(path+"/case_21_1.csv", encoding="utf-8-sig")
    ...
    case_22.to_csv(path+"/case_22.csv", encoding="utf-8-sig")
    ...
    case_23.to_csv(path+"/case_23.csv", encoding="utf-8-sig")
    ...
    case_24.to_csv(path+"/case_24.csv", encoding="utf-8-sig")
    ...
    case_25.to_csv(path+"/case_25.csv", encoding="utf-8-sig")
    ...
    case_26.to_csv(path+"/case_26.csv", encoding="utf-8-sig")
    ...
    case_27.to_csv(path+"/case_27.csv", encoding="utf-8-sig")
    ...
    case_27_1.to_csv(path+"/case_27_1.csv", encoding="utf-8-sig")
    ...
    case_28.to_csv(path+"/case_28.csv", encoding="utf-8-sig")
    ...
    case_29.to_csv(path+"/case_29.csv", encoding="utf-8-sig")
    ...
    case_30.to_csv(path+"/case_30.csv", encoding="utf-8-sig")
    ...
    case_31.to_csv(path+"/case_31.csv", encoding="utf-8-sig")
    ...
    case_32.to_csv(path+"/case_32.csv", encoding="utf-8-sig")
    ...
    case_33.to_csv(path+"/case_33.csv", encoding="utf-8-sig")
    ...
    case_34.to_csv(path+"/case_34.csv", encoding="utf-8-sig")
    ...
    case_35.to_csv(path+"/case_35.csv", encoding="utf-8-sig")
    df = df[~df.index.isin(case_35_index)]



    # 모임으로 끝나는 케이스
    case_36_index = df[(df["적요_pre"].str.endswith("모임"))].index.tolist()
    case_36 = df[df.index.isin(case_36_index)].copy()
    case_36.to_csv(path+"/case_36.csv", encoding="utf-8-sig")
    ...
    case_37.to_csv(path+"/case_37.csv", encoding="utf-8-sig")
    ...
    case_38.to_csv(path+"/case_38.csv", encoding="utf-8-sig")
    ...
    case_39.to_csv(path+"/case_39.csv", encoding="utf-8-sig")
    ...
    case_39_1.to_csv(path+"/case_39_1.csv", encoding="utf-8-sig")
    ...
    case_40.to_csv(path+"/case_40.csv", encoding="utf-8-sig")
    ...
    case_41.to_csv(path+"/case_41.csv", encoding="utf-8-sig")
    ...
    case_41_1.to_csv(path+"/case_41_1.csv", encoding="utf-8-sig")
    ...
    case_42.to_csv(path+"/case_42.csv", encoding="utf-8-sig")
    df = df[~df.index.isin(case_42_index)]



    # 인센티브로 끝나는 케이스
    case_43_index = df[((df["적요_pre"].str.endswith(("인센티브", "인센티", "인센"))))].index.tolist()
    case_43 = df[df.index.isin(case_43_index)].copy()
    case_43.to_csv(path+"/case_43.csv", encoding="utf-8-sig")
    ...
    case_43_1.to_csv(path+"/case_43_1.csv", encoding="utf-8-sig")
    ...
    case_44.to_csv(path+"/case_44.csv", encoding="utf-8-sig")
    ...
    case_45.to_csv(path+"/case_45.csv", encoding="utf-8-sig")
    ...
    case_46.to_csv(path+"/case_46.csv", encoding="utf-8-sig")
    ...
    case_47.to_csv(path+"/case_47.csv", encoding="utf-8-sig")
    ...
    case_48.to_csv(path+"/case_48.csv", encoding="utf-8-sig")
    ...
    case_49.to_csv(path+"/case_49.csv", encoding="utf-8-sig")
    ...
    case_50.to_csv(path+"/case_50.csv", encoding="utf-8-sig")
    ...
    case_51.to_csv(path+"/case_51.csv", encoding="utf-8-sig")
    ...
    case_52.to_csv(path+"/case_52.csv", encoding="utf-8-sig")
    ...
    case_53.to_csv(path+"/case_53.csv", encoding="utf-8-sig")
    ...
    case_54.to_csv(path+"/case_54.csv", encoding="utf-8-sig")
    ...
    case_55.to_csv(path+"/case_55.csv", encoding="utf-8-sig")
    ...
    case_55_1.to_csv(path+"/case_55_1.csv", encoding="utf-8-sig")
    ...
    case_56.to_csv(path+"/case_56.csv", encoding="utf-8-sig")
    ...
    case_57.to_csv(path+"/case_57.csv", encoding="utf-8-sig")
    ...
    case_58.to_csv(path+"/case_58.csv", encoding="utf-8-sig")
    ...
    case_59.to_csv(path+"/case_59.csv", encoding="utf-8-sig")
    ...
    case_60.to_csv(path+"/case_60.csv", encoding="utf-8-sig")
    ...
    case_61.to_csv(path+"/case_61.csv", encoding="utf-8-sig")
    ...
    case_62.to_csv(path+"/case_62.csv", encoding="utf-8-sig")
    ...
    case_63.to_csv(path+"/case_63.csv", encoding="utf-8-sig")
    ...
    case_64.to_csv(path+"/case_64.csv", encoding="utf-8-sig")
    ...
    case_65.to_csv(path+"/case_65.csv", encoding="utf-8-sig")
    ...
    case_66.to_csv(path+"/case_66.csv", encoding="utf-8-sig")
    ...
    case_67.to_csv(path+"/case_67.csv", encoding="utf-8-sig")
    ...
    case_67_1.to_csv(path+"/case_67_1.csv", encoding="utf-8-sig")
    ...
    case_68.to_csv(path+"/case_68.csv", encoding="utf-8-sig")
    ...
    case_69.to_csv(path+"/case_69.csv", encoding="utf-8-sig")
    ...
    case_69_1.to_csv(path+"/case_69_1.csv", encoding="utf-8-sig")
    ...
    case_69_2.to_csv(path+"/case_69_2.csv", encoding="utf-8-sig")
    ...
    case_70.to_csv(path+"/case_70.csv", encoding="utf-8-sig")
   ...
   # 은행명으로 시작하고 뒤에 회사나 법인이 들어있는 경우
    ...
    case_71.to_csv(path+"/case_71.csv", encoding="utf-8-sig")
    ...
    case_72.to_csv(path+"/case_72.csv", encoding="utf-8-sig")
    ...
    case_73.to_csv(path+"/case_73.csv", encoding="utf-8-sig")
    ...
    case_74.to_csv(path+"/case_74.csv", encoding="utf-8-sig")
    ...
    case_75.to_csv(path+"/case_75.csv", encoding="utf-8-sig")
    ...
    case_76.to_csv(path+"/case_76.csv", encoding="utf-8-sig")
    df = df[~df.index.isin(case_76_index)]



    # 단으로 끝나는 경우
    case_77_index = df[(df["적요_pre"].str.endswith("공단"))].index.tolist()
    case_77 = df[df.index.isin(case_77_index)].copy()
    case_77.to_csv(path+"/case_77.csv", encoding="utf-8-sig")
    ...
    case_78.to_csv(path+"/case_78.csv", encoding="utf-8-sig")
    ...
    case_79.to_csv(path+"/case_79.csv", encoding="utf-8-sig")
    ...
    case_80.to_csv(path+"/case_80.csv", encoding="utf-8-sig")
    ...
    case_80_1.to_csv(path+"/case_80_1.csv", encoding="utf-8-sig")
    ...
    case_80_2.to_csv(path+"/case_80_2.csv", encoding="utf-8-sig")
    ...
    case_80_3.to_csv(path+"/case_80_3.csv", encoding="utf-8-sig")
    ...
    case_81.to_csv(path+"/case_81.csv", encoding="utf-8-sig")
    ...
    case_81_1.to_csv(path+"/case_81_1.csv", encoding="utf-8-sig")
    ...
    case_82.to_csv(path+"/case_82.csv", encoding="utf-8-sig")
    ...
    case_83.to_csv(path+"/case_83.csv", encoding="utf-8-sig")
    df = df[~df.index.isin(case_83_index)]



    # 협회로 끝나는 경우
    case_84_index = df[(df["적요_pre"].str.endswith("협회"))].index.tolist()
    case_84 = df[df.index.isin(case_84_index)].copy()
    case_84.to_csv(path+"/case_84.csv", encoding="utf-8-sig")
    ...
    case_85.to_csv(path+"/case_85.csv", encoding="utf-8-sig")
    ...
    case_86.to_csv(path+"/case_86.csv", encoding="utf-8-sig")
    ...
    case_87.to_csv(path+"/case_87.csv", encoding="utf-8-sig")
    ...
    case_88.to_csv(path+"/case_88.csv", encoding="utf-8-sig")
    ...
    case_89.to_csv(path+"/case_89.csv", encoding="utf-8-sig")
    ...
    case_89_1.to_csv(path+"/case_89_1.csv", encoding="utf-8-sig")
    ...
    case_89_2.to_csv(path+"/case_89_2.csv", encoding="utf-8-sig")
    ...
    case_90.to_csv(path+"/case_90.csv", encoding="utf-8-sig")
    ...
    case_91.to_csv(path+"/case_91.csv", encoding="utf-8-sig")
    ...
    case_92.to_csv(path+"/case_92.csv", encoding="utf-8-sig")
    ...
    case_93.to_csv(path+"/case_93.csv", encoding="utf-8-sig")
    ...
    case_94.to_csv(path+"/case_94.csv", encoding="utf-8-sig")
    ...
    case_94_1.to_csv(path+"/case_94_1.csv", encoding="utf-8-sig")
    ...
    case_95.to_csv(path+"/case_95.csv", encoding="utf-8-sig")
    ...
    case_96.to_csv(path+"/case_96.csv", encoding="utf-8-sig")
    ...
    case_97.to_csv(path+"/case_97.csv", encoding="utf-8-sig")
    ...
    case_98.to_csv(path+"/case_98.csv", encoding="utf-8-sig")
    df = df[~df.index.isin(case_98_index)]
    
    # 0회로 끝나는 경우
    case_99_index = df[(df["적요_pre"].str.endswith("0회"))].index.tolist()
    case_99 = df[df.index.isin(case_99_index)].copy()
    case_99.to_csv(path+"/case_99.csv", encoding="utf-8-sig")
    ...
    case_100.to_csv(path+"/case_100.csv", encoding="utf-8-sig")
    ...
    case_101.to_csv(path+"/case_101.csv", encoding="utf-8-sig")
    ...
    case_102.to_csv(path+"/case_102.csv", encoding="utf-8-sig")
    df = df[~df.index.isin(case_102_index)]

    # 00회로 끝나는 경우
    case_103_index = df[(df["적요_pre"].str.endswith(tuple(even_word_for_contains.split("|"))))].index.tolist()
    case_103 = df[df.index.isin(case_103_index)].copy()
    case_103.to_csv(path+"/case_103.csv", encoding="utf-8-sig")
    df = df[~df.index.isin(case_103_index)]
    
    # 상환으로 끝나는 경우
    case_104_index = df[(df["적요_pre"].str.endswith("상환"))].index.tolist()
    case_104 = df[df.index.isin(case_104_index)].copy()
    case_104.to_csv(path+"/case_104.csv", encoding="utf-8-sig")
    df = df[~df.index.isin(case_104_index)]
    

    # 이체로 끝나는 경우
    case_105_index = df[(df["적요_pre"].str.endswith("이체"))].index.tolist()
    case_105 = df[df.index.isin(case_105_index)].copy()
    case_105.to_csv(path+"/case_105.csv", encoding="utf-8-sig")
    ...
    case_106.to_csv(path+"/case_106.csv", encoding="utf-8-sig")
    ...
    case_107.to_csv(path+"/case_107.csv", encoding="utf-8-sig")
    ...
    case_108.to_csv(path+"/case_108.csv", encoding="utf-8-sig")
    ...
    case_109.to_csv(path+"/case_109.csv", encoding="utf-8-sig")
    ...
    case_110.to_csv(path+"/case_110.csv", encoding="utf-8-sig")
    ...
    case_111.to_csv(path+"/case_111.csv", encoding="utf-8-sig")
    ...
    # case_112.to_csv(path+"/case_112.csv", encoding="utf-8-sig")
    # df = df[~df.index.isin(case_112_index)]
    
    # 단으로 끝나는 경우
    case_999_index = df[(df["적요_pre"].str.endswith("단"))].index.tolist()
    case_999 = df[df.index.isin(case_999_index)].copy()
    case_999.to_csv(path+"/case_999.csv", encoding="utf-8-sig")
    df = df[~df.index.isin(case_999_index)]
    

    df.to_csv(path+"/etc.csv", encoding="utf-8-sig")
