...
fina_word_for_contains = "|".join(["수익", "중도", "일반", "빠른", "보료", "법인카드", "결제대금", "개인경비", \
                                    ...
                                    "출장비", "국민연금", "퇴직", "출장", "매출", "위탁", "이용료", "중도", "가맹점", \
                                    "사후", "퇴사", "중간", "출장여비", "퇴직금", "퇴직"])
...
insu_word_for_contains = "|".join(["화재보험료", "종신보험료", "연금보험", "종신보험", "암보험", "건강보험", \
                                    "실비보험", "운전자보험", "손해보험", "보험료", "보험비", "암보험",\
                                    "고용보험", "사회보험", "산재보험", "자가보험", "총괄보험", "우체국보험", \
                                    "상조보험", "지원보험", "여행자보험", "치과보험", "녹십자보험", "화재보험", \
                                    "해상보험", "보험"])
...
unio_word_for_contains = "|".join(["환경", "선교", "전국", "주권", "기독", "운동", "시민", "녹색", "학생", "여성", "서울", \
                                    "학원", "노동", "협동", "공제", "사주"])

cent_word_for_contains = "|".join(["청소년", "아동", "법률", "시민", "주민", "돌봄", "여성", "치매안심", "방문요양", "노인요양", \
                                    "간호요양", "지원", "교육", "체육", "장애인", "가족", "노인복지", "복지", "스포츠", "보호", \
                                    "문화", "아트", "자활"])
